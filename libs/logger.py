...
class Logger(logging.Logger):
    def __init__(self, name="Base", log=False):
        ...
        self.__logger__format__ = f"[{self.name}][%(asctime)s][%(threadName)s/%(levelname)s]: %(message)s"
    ...
    def __set_logger(self):
        self.__logger__format__ = f"\033[36m[\033[32m{self.name}\033[36m]" \
